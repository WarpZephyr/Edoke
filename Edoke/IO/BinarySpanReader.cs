...
namespace Edoke.IO
{
    ...
    public ref struct BinarySpanReader
    {
        ...
        /// <param name="bigEndian">Whether or not to read in big endian.</param>
        public BinarySpanReader(Span<byte> buffer, bool bigEndian) : this((ReadOnlySpan<byte>)buffer, bigEndian) { }
        ...
        /// <param name="bigEndian">Whether or not to read in big endian.</param>
        public BinarySpanReader(byte[] buffer, bool bigEndian) : this(new ReadOnlySpan<byte>(buffer), bigEndian) { }

        /// <summary>
        /// Create a new <see cref="BinarySpanReader"/> from a <see cref="ReadOnlySpan{T}"/> of <see cref="byte"/>.
        /// </summary>
        /// <param name="buffer">The <see cref="ReadOnlySpan{T}"/> to read.</param>
        public BinarySpanReader(ReadOnlySpan<byte> buffer) : this(buffer, !BitConverter.IsLittleEndian) { }

        /// <summary>
        /// Create a new <see cref="BinarySpanReader"/> from a <see cref="Span{T}"/> of <see cref="byte"/>.
        /// </summary>
        /// <param name="buffer">The <see cref="Span{T}"/> to read.</param>
        public BinarySpanReader(Span<byte> buffer) : this((ReadOnlySpan<byte>)buffer, !BitConverter.IsLittleEndian) { }

        /// <summary>
        /// Create a new <see cref="BinarySpanReader"/> from an <see cref="Array"/> of <see cref="byte"/>.
        /// </summary>
        /// <param name="buffer">The <see cref="Array"/> to read.</param>
        public BinarySpanReader(byte[] buffer) : this(new ReadOnlySpan<byte>(buffer), !BitConverter.IsLittleEndian) { }
        ...
        public ReadOnlySpan<sbyte> ReadSByteSpan(int count)
        {
            ...
            var value = Buffer.Slice(BufferOffset, count);
            BufferOffset = endPosition;
            return MemoryMarshal.Cast<byte, sbyte>(value);
        }
        ...
        public sbyte[] ReadSBytes(int count)
            => ReadSByteSpan(count).ToArray();

        /// <summary>
        /// Gets a <see cref="sbyte"/> at the specified position.
        /// </summary>
        /// <param name="position">The specified position.</param>
        /// <returns>A <see cref="sbyte"/>.</returns>
        /// <exception cref="InvalidOperationException">The read went beyond the specified span.</exception>
        ...
        public readonly ReadOnlySpan<sbyte> GetSByteSpan(int position, int count)
        {
            ...
            return MemoryMarshal.Cast<byte, sbyte>(Buffer.Slice(position, count));
        }
        ...
        public readonly sbyte[] GetSBytes(int position, int count)
            => GetSByteSpan(position, count).ToArray();

        /// <summary>
        /// Reads a <see cref="sbyte"/> and throws if it is not the specified option.
        /// </summary>
        ...
        /// <summary>
        /// Reads a <see cref="sbyte"/> and throws if it is not one of the specified options.
        /// </summary>
        ...
        public readonly ReadOnlySpan<byte> GetByteSpan(int position, int count)
        {
            ...
            return Buffer.Slice(position, count);
        }
        ...
        /// <param name="position">The specified position.</param>
        /// <returns>The read value.</returns>
        public readonly long GetVarint(int position)
        {
            if (VarintLong)
            {
        ...
        /// <param name="count">The amount to read.</param>
        /// <returns>The read values.</returns>
        public readonly ReadOnlySpan<long> GetVarintSpan(int position, int count)
        {
            if (VarintLong)
            {
        ...
        /// <param name="count">The amount to read.</param>
        /// <returns>The read values.</returns>
        public readonly long[] GetVarints(int position, int count)
        {
            if (VarintLong)
            {
        ...
        /// <param name="position">The specified position.</param>
        /// <returns>A <see cref="Vector2"/>.</returns>
        public readonly Vector2 GetVector2(int position)
        {
            if (IsEndiannessReversed)
            {
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>A <see cref="ReadOnlySpan{T}"/> of <see cref="Vector2"/>.</returns>
        public readonly unsafe ReadOnlySpan<Vector2> GetVector2Span(int position, int count)
        {
            if (IsEndiannessReversed)
            {
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>An <see cref="Array"/> of <see cref="Vector2"/>.</returns>
        public readonly unsafe Vector2[] GetVector2s(int position, int count)
        {
            if (IsEndiannessReversed)
            {
        ...
        /// <param name="position">The specified position.</param>
        /// <returns>A <see cref="Vector3"/>.</returns>
        public readonly Vector3 GetVector3(int position)
        {
            if (IsEndiannessReversed)
            {
                uint xint = Get<uint>(position);
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>A <see cref="ReadOnlySpan{T}"/> of <see cref="Vector3"/>.</returns>
        public readonly unsafe ReadOnlySpan<Vector3> GetVector3Span(int position, int count)
        {
            if (IsEndiannessReversed)
            {
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>An <see cref="Array"/> of <see cref="Vector3"/>.</returns>
        public readonly unsafe Vector3[] GetVector3s(int position, int count)
        {
            if (IsEndiannessReversed)
            {
                var span = GetUInt32Span(position, count * 3);
        ...
        /// <param name="position">The specified position.</param>
        /// <returns>A <see cref="Vector4"/>.</returns>
        public readonly Vector4 GetVector4(int position)
        {
            if (IsEndiannessReversed)
            {
                uint xint = Get<uint>(position);
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>A <see cref="ReadOnlySpan{T}"/> of <see cref="Vector4"/>.</returns>
        public readonly unsafe ReadOnlySpan<Vector4> GetVector4Span(int position, int count)
        {
            if (IsEndiannessReversed)
            {
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>An <see cref="Array"/> of <see cref="Vector4"/>.</returns>
        public readonly unsafe Vector4[] GetVector4s(int position, int count)
        {
            if (IsEndiannessReversed)
            {
                var span = GetUInt32Span(position, count * 4);
        ...
        /// <param name="position">The specified position.</param>
        /// <returns>A <see cref="Quaternion"/>.</returns>
        public readonly Quaternion GetQuaternion(int position)
        {
            if (IsEndiannessReversed)
            {
                uint xint = Get<uint>(position);
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>A <see cref="ReadOnlySpan{T}"/> of <see cref="Quaternion"/>.</returns>
        public readonly unsafe ReadOnlySpan<Quaternion> GetQuaternionSpan(int position, int count)
        {
            if (IsEndiannessReversed)
            {
                var span = GetUInt32Span(position, count * 4);
        ...
        /// <param name="count">The amount to get.</param>
        /// <returns>An <see cref="Array"/> of <see cref="Quaternion"/>.</returns>
        public readonly unsafe Quaternion[] GetQuaternions(int position, int count)
        {
            if (IsEndiannessReversed)
            {
                var span = GetUInt32Span(position, count * 4);
        ...
        private ReadOnlySpan<byte> Read16BitStringSpan(int length)
        {
            ...
            var span = Buffer;
            span = span[BufferOffset..length];
            span = span[..StringLengthHelper.WStrlen(span)];
            BufferOffset += length;
            return span;
        }
        ...
        /// <summary>
        /// Reads a ASCII encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a ASCII encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a UTF8 encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a UTF8 encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a ShiftJIS encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a ShiftJIS encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a big-endian UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a big-endian UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a little-endian UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not the specified option.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="option">The option to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Reads a little-endian UTF16 encoded <see cref="string"/> in a fixed-size field and throws if it is not one of the specified options.
        /// </summary>
        /// <param name="length">The byte length of the fixed field.</param>
        /// <param name="options">The options to assert the <see cref="string"/> as.</param>
        /// <returns>A <see cref="string"/>.</returns>
